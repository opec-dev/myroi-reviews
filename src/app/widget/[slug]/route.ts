...
export async function GET(_request: Request, { params }: { params: Promise<{ slug: string }> }) {
  ...
  const payload = JSON.stringify({
    ...
    accent: demoBusiness.accent,
    publicUrl: `/reviews/${slug}`,
    reviews: demoReviews,
  }).replaceAll("<", "\\u003c");
