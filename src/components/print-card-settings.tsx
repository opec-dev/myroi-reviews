...
export function PrintCardSettingsEditor() {
  ...
  return <>
    ...
    <div className="badge-options"><strong>Platform artwork</strong><label><input type="checkbox" checked={settings.platformBadges.includes("google-yelp")} onChange={() => toggleBadge("google-yelp")} /> Google + Yelp badge</label><small>Additional client or industry logos can occupy a second row in the connected version.</small></div>
